  ...
  <section id="contact">
    <v-layout pa-5 wrap>
      ...
      <v-flex xs12 md5 mb-4 :pr-5="$vuetify.breakpoint.mdAndUp">
        ...
        >Have anything that you would like to say to me? Well you are more than welcome to do so. Please fill out the form below and hit that send button or else get in touch using the details given along with the form.</div>
        ...
        >
          <v-layout wrap>
            ...
            <v-flex xs12 :class="{ 'mb-2': successAlert }">
              <v-alert :value="successAlert" type="success">Message Sent.</v-alert>
            </v-flex>

            <v-flex xs12 :class="{ 'mb-2': infoAlert }">
              <v-alert :value="infoAlert" type="info">Sending....</v-alert>
            </v-flex>
      ...
      <v-flex xs12 md3 text-xs-left>
        ...
        <v-list class="transparent" three-line>
          <v-list-tile avatar v-for="(det, i) in contactDetails" :key="i">
            <v-list-tile-avatar>
            ...
            <v-list-tile-content>
              ...
              <v-list-tile-sub-title>{{ det.val }}</v-list-tile-sub-title>
            </v-list-tile-content>
          </v-list-tile>
        </v-list>
      </v-flex>
